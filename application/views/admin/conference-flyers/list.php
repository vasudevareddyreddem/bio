<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Conference Flyers List
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url('dashboard'); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Conference Flyers List</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Conference Flyers List</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><img width="50px" height="50px" src="<?php echo base_url('assets/conference_flyers_img/'.$list['fly_image']); ?>">
				  </td>
                  <td><?php echo htmlentities($list['title_color']); ?></td>
                  <td><?php if($list['status']==1){ echo "Active"; }else{ echo "deactive";} ?></td>
                  <td>
					<a href="<?php echo base_url('conference-flyers/edit/'.base64_encode($list['f_id'])); ?>"><i class="fa fa-edit"></i></a>
					&nbsp;&nbsp;
...
function admindeactive(id){
	$(".popid").attr("href","<?php echo base_url('conference-flyers/status'); ?>"+"/"+id);
}

function admindedelete(id){
	$(".popid").attr("href","<?php echo base_url('conference-flyers/delete'); ?>"+"/"+id);
}
  $(function () {
    $("#example1").DataTable();
    $('#example2').DataTable({
